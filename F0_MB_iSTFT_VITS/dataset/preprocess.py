...
def jsut_preprocess(dataset_dir:str = "./jsut_ver1.1/basic5000/", results_folder="./dataset/jsut/", target_sr:int = 22050):
...
def ita_preprocess(dataset_dir:str = "./path/to/ita_corpus", results_folder="./dataset/ita/", target_sr:int = 22050):
    os.makedirs(results_folder, exist_ok=True)
...
def homebrew_preprocess(dataset_dir:str = "./homebrew/", results_folder="./dataset/homebrew/", target_sr:int = 22050):
    os.makedirs(results_folder, exist_ok=True)
    wav_dir = dataset_dir
